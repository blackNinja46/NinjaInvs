...
import live.blackninja.ninjaInvs.opener.ChestInventoryOpener;
import live.blackninja.ninjaInvs.opener.InventoryOpener;
import live.blackninja.ninjaInvs.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<UUID, NinjaInventory> inventories;
    ...
    public List<Player> getOpenedPlayers(NinjaInventory inv) {
    ...
    public Optional<NinjaInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p.getUniqueId()));
    }

    protected void setInventory(Player p, NinjaInventory inv) {
        if (inv == null)
    ...
    public void handleInventoryOpenError(NinjaInventory inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while opening NinjaInventory:", exception);
    }

    public void handleInventoryUpdateError(NinjaInventory inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while updating NinjaInventory:", exception);
    }
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (clickedInventory == p.getOpenInventory().getTopInventory()) {
                ...
                NinjaInventory inv = inventories.get(p.getUniqueId());
