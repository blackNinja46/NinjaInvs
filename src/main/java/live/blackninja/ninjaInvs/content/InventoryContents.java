package live.blackninja.ninjaInvs.content;
...
public interface InventoryContents {
    ...
    class Impl implements InventoryContents {
        ...
        public Impl(NinjaInventory inv, UUID player) {
            this.inv = inv;
            this.player = player;
        ...
        @Override
        public NinjaInventory inventory() { return inv; }
